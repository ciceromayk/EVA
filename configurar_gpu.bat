...
py -3.12 -E -m pip install nvidia-cuda-runtime-cu12 nvidia-cublas-cu12 nvidia-curand-cu12 nvidia-cusparse-cu12 nvidia-cusolver-cu12 nvidia-cufft-cu12 nvidia-nvrtc-cu12 nvidia-cuda-nvrtc-cu12
echo.
echo ============================================
echo  Testando a GPU...
echo ============================================
